...
export const JOURNEYS = [
  {
    ...
    description: "Explore my technical architecture and code",
    emoji: "⚙️",
    accent: "#6366f1",
  },
  {
    id: "ai",
    label: "AI Engineer",
    description: "See my machine learning pipelines and models",
    emoji: "🧠",
    accent: "#8b5cf6",
  },
  {
    ...
    description: "Browse campaigns, reels, and visual work",
    emoji: "🎨",
    accent: "#f59e0b",
  },
  {
    ...
    description: "Learn about my companies and products",
    emoji: "🚀",
    accent: "#10b981",
  },
  {
    id: "design",
    label: "Media & Brand",
    description: "Discover brand identities and design systems",
    emoji: "✦",
    accent: "#f43f5e",
  },
];
